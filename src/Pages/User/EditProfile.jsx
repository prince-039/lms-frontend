    ...
    <HomeLayout>
       <div className="flex items-center justify-center h-[100vh]">
         <form
          ...
          className="flex flex-col justify-center gap-5 rounded-lg p-4 text-white w-80 min-h-[28rem] shadow-[0_0_10px_black]"
         ...
         >
          <h1 className="text-center text-2xl font-semibold">Edit profile</h1>
           ...
           <button type="submit" className="w-full bg-yellow-600 hover:bg-yellow-500  duration-300 rounded-sm py-2 text-lg">
            Update profile
           </button>
