...
import aboutMainImage1 from "../Assets/Images/aboutMainImage1.jpeg";
 ...
 return (
    <HomeLayout>
        <div className="pl-20 pt-20 flex flex-col text-white">
          <div className="flex items-center gap-5 mx-10">
            <section className="w-1/2 space-y-10">
             ...
             <p className="text-xl text-grey-200">
                ...
                to share their skills and creativity and knowledge to each other to 
         ...
         <div className="carousel w-1/3 m-16 m-auto">
